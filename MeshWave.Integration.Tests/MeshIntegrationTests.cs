...
public class MeshIntegrationTests : IAsyncLifetime
{
    ...
    public async Task Jane_CanDownload_JohnsDeskPlastic_TrackByContentHash()
    {
        ...
        _output.WriteLine($"Jane trying to download hash: {hash} from John. John peer count: {john.Orchestrator.ConnectedPeerCount}, Jane peer count: {jane.Orchestrator.ConnectedPeerCount}");
